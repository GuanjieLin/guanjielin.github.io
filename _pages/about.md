...
# <i class="fas fa-file-alt section-icon" aria-hidden="true"></i> Publications 

{% include publications.html %}

<span class='anchor' id='services'></span>

# <i class="fas fa-hands-helping section-icon" aria-hidden="true"></i> Services

- STPC of ACM IMC 2026
